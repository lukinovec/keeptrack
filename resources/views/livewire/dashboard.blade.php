<div x-data="{ infoid: '' }">
    <div class="text-center">
        <div class="w-full">
            <input wire:model.debounce.300ms="search" x-on:keydown="" type="text" placeholder="Search something"
        ...
        <div class="mt-4 flex flex-wrap" :class="{ 'items-center justify-center' : infoid === '' }">
            ...
            <div x-show="infoid === '{{$item['id']}}' || infoid === ''"
                ...
                <div class="info flex font-bold">
                    <a class="flex-1 text-center p-5 text-white font-bold bg-red-700"
                        x-on:click="infoid ? infoid = '' : infoid = '{{ $item["id"] }}'; $wire.set('details', ''); $wire.getDetails(infoid)"
