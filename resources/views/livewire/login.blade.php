<div class="auth-wrapper" x-data="{ logging: @entangle('logging') }">
    <div class="auth">
        <input type="email" class="input w-full" name="email" placeholder="Email" wire:model.defer="email" />
        <br><br>
        <input type="password" class="input w-full" name="password" placeholder="Password" wire:model.defer="password" />
        <br>
        <span class="flex">
