<div class="h-full w-full">
    ...
    @endif
    @if ($library->count() > 0 && $type === "movies")
        ...
        <div x-data='{
            ...
            <div class="item relative text-white w-5/6">
                <div class="w-full bg-gray-700">
                    ...
                    <div class="absolute w-full h-full pb-32 flex flex-col text-left" x-show="edit.apiID == item.apiID"
                        ...
                        <span class="flex-1 mx-3">
                            Note: <input class="edit" x-model="item.note" type="text">
                        </span>
                        <br>
                        <span class="flex-1 mx-3">
                            Status: <select class="edit w-24" x-model="item.status" name="status">
