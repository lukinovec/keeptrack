<div class="flex flex-row  w-full justify-evenly align-middle">
    <a href="/library/movie">
        <div x-transition:enter="transition ease-out duration-300"
            ...
            <svg fill="rgba(203, 213, 225)" class="icon-film m-auto rounded-full h-12 w-12 sm:h-24 sm:w-24 transform duration-150 p-2 hover:scale-110 bg-transparent border-4 border-blueGray-300" viewBox="-31 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="evenodd">
