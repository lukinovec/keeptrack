<div class="flex flex-col sm:flex-row w-full justify-evenly items-center" style="height: 59%">
    <div class="flex flex-1">
        <div x-data='{ item: @json($latestMovie) }' class="flex-1 text-center">
            <h1 class="text-white">Recent</h1>
            ...
            <br>
            <button class="btn p-1" x-on:click="$wire.submitChanges(item)">Update</button>
        </div>
        {{-- <br> --}}
        <div class="flex-1">
            ...
            <a href="/library/movie">
                <div x-transition:enter="transition ease-out duration-300"
                    ...
                    <svg fill="rgba(203, 213, 225)"
                        class="icon-film m-auto rounded-full h-12 w-12 sm:h-24 sm:w-24 transform duration-150 p-2 hover:scale-110 bg-transparent border-4 border-blueGray-300"
    ...
    <div class="flex-1">
        <h1>{{ Auth::user()->bookList(1)->first()["name"] }}</h1>
        <a href="/library/book">
            <div x-transition:enter="transition ease-out duration-300"
                x-transition:enter-start="opacity-0 transform scale-90"
                x-transition:enter-end="opacity-100 transform scale-100"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(203, 213, 225)"
                    class="icon-book-open m-auto rounded-full h-12 w-12 sm:h-24 sm:w-24 transform duration-150 p-2 hover:scale-110 bg-transparent border-4 border-blueGray-300">
                    <g>
