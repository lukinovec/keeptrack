            ...
            <div class="max-w-4xl mx-auto relative" x-data="{ activeSlide: 1, slides: [1, 2] }">
                ...
                <div class="absolute inset-0 flex">
                    <div class="flex items-center justify-start w-1/2">
                        <button
                            class="bg-blueGray-300 text-blueGray-900 hover:text-orange-500 font-bold hover:shadow-lg rounded-full w-12 h-12 ml-4"
                    ...
                    <div class="flex items-center justify-end w-1/2">
                        <button
                            class="bg-blueGray-300 text-blueGray-900 hover:text-orange-500 font-bold hover:shadow rounded-full w-12 h-12 mr-4"
