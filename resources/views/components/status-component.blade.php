<span class="flex-1 mx-3">
    ...
    <select id="status" class="w-40 p-1 bg-transparent border-4 text-blueGray-300 border-blueGray-300 rounded-xxl" x-model="item.status" name="status">
        ...
        <option class="text-gray-700" value="ptw" x-text="item.statuses['ptw']"></option>
        <option class="text-gray-700" x-show="item.type != 'movie'" value="watching" x-text="item.statuses['watching']"></option>
    </select>
</span>